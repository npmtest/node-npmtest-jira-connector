...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jira-connector/node_modules/jira-connector/api/sprint.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jira-connector/node_modules/jira-connector/api/sprint.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jira-connector/node_modules/jira-connector/api/</a> &#187; sprint.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function AgileSprintClient(jiraClient) {</span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.createSprint = <span class="fstat-no" title="function not covered" >function (sprint, callback) {</span></span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.getSprint = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var options = {</span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.updateSprint = <span class="fstat-no" title="function not covered" >function (sprint, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var sprintId = sprint.sprintId;</span>
<span class="cstat-no" title="statement not covered" >    delete sprint.sprintId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var options = {</span>
...
&nbsp;
   ...
   * @return {Promise} Resolved when the sprint has been updated.
   */
<span class="cstat-no" title="statement not covered" >  this.partiallyUpdateSprint = <span class="fstat-no" title="function not covered" >function (sprint, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var sprintId = sprint.sprintId;</span>
<span class="cstat-no" title="statement not covered" >    delete sprint.sprintId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var options = {</span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.deleteSprint = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var options = {</span>
      uri: this.jiraClient.buildAgileURL('/sprint/' + opts.sprintId),
      method: 'DELETE',
      json: true,
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.getSprintIssues = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var options = {</span>
...
&nbsp;
   ...
   * @return {Promise} Resolved when the sprint has been retrieved.
   */
<span class="cstat-no" title="statement not covered" >  this.moveSprintIssues = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var sprintId = opts.sprintId;</span>
<span class="cstat-no" title="statement not covered" >    delete opts.sprintId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var options = {</span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.swapSprint = <span class="fstat-no" title="function not covered" >function (swapped, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var sprintId = swapped.sprintId;</span>
<span class="cstat-no" title="statement not covered" >    delete swapped.sprintId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var options = {</span>

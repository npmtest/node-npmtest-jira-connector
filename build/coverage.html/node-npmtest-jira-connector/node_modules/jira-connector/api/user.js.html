...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jira-connector/node_modules/jira-connector/api/user.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jira-connector/node_modules/jira-connector/api/user.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jira-connector/node_modules/jira-connector/api/</a> &#187; user.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function UserClient(jiraClient) {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.getUser = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            options.qs.expand = '';</span>
...
<span class="cstat-no" title="statement not covered" >                options.qs.expand += ex + ','</span>
            });
        }
&nbsp;
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.deleteUser = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
            uri: this.jiraClient.buildURL('/user'),
            method: 'DELETE',
            json: true,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'User removed.');</span>
    };
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.createUser = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
            uri: this.jiraClient.buildURL('/user'),
            method: 'POST',
            json: true,
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.editUser = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
            uri: this.jiraClient.buildURL('/user'),
            method: 'PUT',
            json: true,
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.multiProjectSearchAssignable = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var projectKeyString = '';</span>
<span class="cstat-no" title="statement not covered" >        if (opts.projectKeys) {</span>
<span class="cstat-no" title="statement not covered" >            opts.projectKeys.forEach(<span class="fstat-no" title="function not covered" >function (key) {</span></span>
<span class="cstat-no" title="statement not covered" >                projectKeyString += key + ',';</span>
            });
<span class="cstat-no" title="statement not covered" >            projectKeyString = projectKeyString.slice(0, -1);</span>
        }
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     * @return {Promise} Resolved when the search results have been retrieved.
     */
<span class="cstat-no" title="statement not covered" >    this.searchAssignable = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.createTemporaryAvatar = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var extension = path.extname(opts.filepath).slice(1);</span>
<span class="cstat-no" title="statement not covered" >        var baseName = path.basename(opts.filepath);</span>
<span class="cstat-no" title="statement not covered" >        var fileSize = fs.statSync(opts.filepath).size;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        extension = extension == 'jpg' ? 'jpeg' : extension;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.convertTemporaryAvatar = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'Avatar Converted');</span>
    };
&nbsp;
    /**
     * Deletes avatar
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.deleteAvatar = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'Avatar Deleted');</span>
    };
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.getAvatars = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.getDefaultColumns = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.setDefaultColumns = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
            uri: this.jiraClient.buildURL('/user/columns'),
            method: 'PUT',
            json: true,
...
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'Default Columns Set');</span>
    };
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.resetDefaultColumns = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
            uri: this.jiraClient.buildURL('/user/columns'),
            method: 'DELETE',
            json: true,
...
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'Default Columns Reset');</span>
    };
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.changePassword = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'Password Changed');</span>
    };
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.searchPermissions = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var permissions = '';</span>
<span class="cstat-no" title="statement not covered" >        if (opts.permissions) {</span>
<span class="cstat-no" title="statement not covered" >            opts.permissions.forEach(<span class="fstat-no" title="function not covered" >function (s) {</span></span>
<span class="cstat-no" title="statement not covered" >                permissions += s + ','</span>
            });
<span class="cstat-no" title="statement not covered" >            permissions = permissions.slice(0, -1);</span>
        }
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     * @return {Promise} Resolved when the search results are retrieved.
     */
<span class="cstat-no" title="statement not covered" >    this.searchPicker = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     * @return {Promise} Resolved when the search results are retrieved.
     */
<span class="cstat-no" title="statement not covered" >    this.search = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.viewIssueSearch = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        var options = {</span>

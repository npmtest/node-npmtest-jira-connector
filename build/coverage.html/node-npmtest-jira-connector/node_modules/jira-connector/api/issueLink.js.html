...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jira-connector/node_modules/jira-connector/api/issueLink.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jira-connector/node_modules/jira-connector/api/issueLink.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jira-connector/node_modules/jira-connector/api/</a> &#187; issueLink.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function IssueLinkClient(jiraClient) {</span>
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.createIssueLink = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (!opts.issueLink) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(errorStrings.NO_ISSUE_LINK_ERROR);</span>
        }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'Issue Link Created');</span>
    };
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.getIssueLink = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (!opts.linkId) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(errorStrings.NO_ISSUE_LINK_ID_ERROR);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        var options = {</span>
            method: 'GET',
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.deleteIssueLink = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (!opts.linkId) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(errorStrings.NO_ISSUE_LINK_ID_ERROR);</span>
        }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this.jiraClient.makeRequest(options, callback, 'Issue Link Deleted');</span>
    };
}
&nbsp;</pre></td></tr>
</table></pre>

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jira-connector/node_modules/jira-connector/api/board.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jira-connector/node_modules/jira-connector/api/board.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jira-connector/node_modules/jira-connector/api/</a> &#187; board.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function AgileBoardClient(jiraClient) {</span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.getAllBoards = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.getBoard = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var options = {</span>
...
&nbsp;
   ...
   * @return {Promise} Resolved when the dashboards have been retrieved.
   */
<span class="cstat-no" title="statement not covered" >  this.getIssuesForBoard = <span class="fstat-no" title="function not covered" >function (opts, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >    var options = {</span>
